...
#define SHA512_INITIAL_CONSTANT_A_VALUE (0x6a09e667f3bcc908)
#define SHA512_INITIAL_CONSTANT_B_VALUE (0xbb67ae8584caa73b)
#define SHA512_INITIAL_CONSTANT_C_VALUE (0x3c6ef372fe94f82b)
#define SHA512_INITIAL_CONSTANT_D_VALUE (0xa54ff53a5f1d36f1)
#define SHA512_INITIAL_CONSTANT_E_VALUE (0x510e527fade682d1)
#define SHA512_INITIAL_CONSTANT_F_VALUE (0x9b05688c2b3e6c1f)
#define SHA512_INITIAL_CONSTANT_G_VALUE (0x1f83d9abfb41bd6b)
#define SHA512_INITIAL_CONSTANT_H_VALUE (0x5be0cd19137e2179)

const uint64_t SHA512_round_constants[SHA512_ROUND_NUMBER] =
    {
...
uint8_t Fu8__sha512(hash_input_t *ptr_sstc_pssd_hash_input, hash_output_t *ptr_sstc_pssd_hash_output)
    ...
    */
    ...
    uint64_t  u64_lcl_message_schedule[SHA512_ROUND_NUMBER];
    ...
    uint64_t  u64_lcl_tmp_sha512_calcul_var_1;
    uint64_t  u64_lcl_tmp_sha512_calcul_var_2;
    uint8_t   u8_lcl_block_carry_padding_flag;
    uint8_t   u8_lcl_message_block[SHA512_BLOCK_SIZE_IN_BYTE];
    ...
    */
    ...
    u64_lcl_A_block_data                         = SHA512_INITIAL_CONSTANT_A_VALUE;
    u64_lcl_B_block_data                         = SHA512_INITIAL_CONSTANT_B_VALUE;
    u64_lcl_C_block_data                         = SHA512_INITIAL_CONSTANT_C_VALUE;
    u64_lcl_D_block_data                         = SHA512_INITIAL_CONSTANT_D_VALUE;
    u64_lcl_E_block_data                         = SHA512_INITIAL_CONSTANT_E_VALUE;
    u64_lcl_F_block_data                         = SHA512_INITIAL_CONSTANT_F_VALUE;
    u64_lcl_G_block_data                         = SHA512_INITIAL_CONSTANT_G_VALUE;
    u64_lcl_H_block_data                         = SHA512_INITIAL_CONSTANT_H_VALUE;
    ...
    u64_lcl_tmp_sha512_calcul_var_1              = 0;
    u64_lcl_tmp_sha512_calcul_var_2              = 0;
    ...
    */ 
    u64_lcl_cnt = 0;
    while(u64_lcl_cnt < SHA512_ROUND_NUMBER)
        {
    ...
    */ 
    u64_lcl_cnt = 0;
    while(u64_lcl_cnt < SHA512_BLOCK_SIZE_IN_BYTE)
        {
    ...
    */ 
    u64_lcl_number_of_block_in_the_input_message = ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_ / SHA512_BLOCK_SIZE_IN_BYTE;

    /**
    * Check if the modulo of the length of the input message by the sha512 block size is not zero
    */
    if((ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_ % SHA512_BLOCK_SIZE_IN_BYTE) != 0)
        {
        /**
        * Treat the case when the modulo of the length of the input message by the sha512 block size is not zero
        */
    ...
    /**
    * Compute the sha512 hash using all the blocks message
    */ 
    u64_lcl_actual_block_number = 0;
    while((u64_lcl_actual_block_number < u64_lcl_number_of_block_in_the_input_message) || (u8_lcl_block_carry_padding_flag != FALSE) || (u8_lcl_padding_started_flag == FALSE))
        ...
        */
        if(u8_lcl_block_carry_padding_flag != FALSE)
            ...
            */
            (*((uint128_t *) (u8_lcl_message_block + SHA512_MESSAGE_LENGTH_POSITION_IN_BLOCK))) = u128_lcl_number_of_bit_in_message;
            ...
            */ 
            ...
            while(u64_lcl_cnt < SHA512_BLOCK_SIZE_IN_BYTE)
                ...
                */
                if(((u64_lcl_actual_block_number * SHA512_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt) >= ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_)
                    {
                    /**
                    ...
                    */
                    if(((u64_lcl_actual_block_number * SHA512_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt) == ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_)
                        ...
                        */
                        if(u64_lcl_cnt >= SHA512_MESSAGE_LENGTH_POSITION_IN_BLOCK)
                            {
                            /**
                        ...
                        */
                        if((u8_lcl_block_carry_padding_flag == FALSE) && (u64_lcl_cnt >= SHA512_MESSAGE_LENGTH_POSITION_IN_BLOCK))
                            {
                            /**
                    ...
                    */
                    ...
                    u8_lcl_message_block[u64_lcl_cnt] = ptr_sstc_pssd_hash_input->ptr_u8_data_to_hash_blob_[(u64_lcl_actual_block_number * SHA512_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt];
                    }
        ...
        */ 
        u64_lcl_cnt = 0;
        while(u64_lcl_cnt < (SHA512_BLOCK_SIZE_IN_BYTE / sizeof(uint64_t)))
            {
        ...
        */ 
        while(u64_lcl_cnt < SHA512_ROUND_NUMBER)
            {
            u64_lcl_tmp_sha512_calcul_var_1 = (MACRO_U64_RIGHT_ROTATE(u64_lcl_message_schedule[u64_lcl_cnt - 15], 1) ^ MACRO_U64_RIGHT_ROTATE(u64_lcl_message_schedule[u64_lcl_cnt - 15], 8)) ^ (u64_lcl_message_schedule[u64_lcl_cnt - 15] >> 7);

            u64_lcl_tmp_sha512_calcul_var_2 = (MACRO_U64_RIGHT_ROTATE(u64_lcl_message_schedule[u64_lcl_cnt - 2], 19) ^ MACRO_U64_RIGHT_ROTATE(u64_lcl_message_schedule[u64_lcl_cnt - 2], 61)) ^ (u64_lcl_message_schedule[u64_lcl_cnt - 2] >> 6);

            u64_lcl_message_schedule[u64_lcl_cnt] = u64_lcl_message_schedule[u64_lcl_cnt - 16] + u64_lcl_tmp_sha512_calcul_var_1 + u64_lcl_message_schedule[u64_lcl_cnt - 7] + u64_lcl_tmp_sha512_calcul_var_2;
        ...
        */ 
        ...
        while(u64_lcl_cnt < SHA512_ROUND_NUMBER)
            {
            u64_lcl_tmp_sha512_calcul_var_1 = u64_lcl_tmp_H_block_data + (MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_E_block_data, 14) ^ MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_E_block_data, 18) ^ MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_E_block_data, 41)) + ((u64_lcl_tmp_E_block_data & u64_lcl_tmp_F_block_data) ^ (~(u64_lcl_tmp_E_block_data) & u64_lcl_tmp_G_block_data)) + SHA512_round_constants[u64_lcl_cnt] + u64_lcl_message_schedule[u64_lcl_cnt];

            u64_lcl_tmp_sha512_calcul_var_2 = ((MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_A_block_data, 28)) ^ (MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_A_block_data, 34)) ^ (MACRO_U64_RIGHT_ROTATE(u64_lcl_tmp_A_block_data, 39))) + ((u64_lcl_tmp_A_block_data & u64_lcl_tmp_B_block_data) ^ (u64_lcl_tmp_A_block_data & u64_lcl_tmp_C_block_data) ^ (u64_lcl_tmp_B_block_data & u64_lcl_tmp_C_block_data));
            ...
            u64_lcl_tmp_E_block_data = (u64_lcl_tmp_D_block_data + u64_lcl_tmp_sha512_calcul_var_1);
            u64_lcl_tmp_D_block_data = u64_lcl_tmp_C_block_data;
            u64_lcl_tmp_C_block_data = u64_lcl_tmp_B_block_data;
            u64_lcl_tmp_B_block_data = u64_lcl_tmp_A_block_data;
            u64_lcl_tmp_A_block_data = (u64_lcl_tmp_sha512_calcul_var_1 + u64_lcl_tmp_sha512_calcul_var_2);
    ...
    /**
    * Setting the eight block data of the digest to the structure hash output
    */
    u8_lcl_return_from_function = RETURN_FAILURE;
    u8_lcl_return_from_function = Fu8__preset_output_data_of_structure_hash_output_from_passed_eight_u64(ptr_sstc_pssd_hash_output, u64_lcl_A_block_data, u64_lcl_B_block_data, u64_lcl_C_block_data, u64_lcl_D_block_data, u64_lcl_E_block_data, u64_lcl_F_block_data, u64_lcl_G_block_data, u64_lcl_H_block_data);

    /**
    * Check if function to set the eight block data of the digest to the structure hash output succeeded
    */
    if(u8_lcl_return_from_function != RETURN_SUCCESS)
        {
        /**
        * Treat the case when the function to set the eight block data of the digest to the structure hash output failed
        */

        #ifdef DEVELOPEMENT
        ft_fprintf(STDERR_FILENO, "\033[1;31mERROR\033[0m: in file \033[1m%s\033[0m in function \033[1m%s\033[0m at line \033[1m%d\033[0m\n    The function to set the eight block data of the digest to the structure hash output  failed\n", __FILE__, __func__, __LINE__);
        #endif
        ...
        /**
        * Return failure to indicate the function to set the eight block data of the digest to the structure hash output failed
        */
        return (RETURN_FAILURE);
        }
    else
        {
        /**
        * Treat the case when function to set the eight block data of the digest to the structure hash output suucceeded
        */
        } 
