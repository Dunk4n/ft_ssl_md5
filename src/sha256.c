...
#define SHA256_INITIAL_CONSTANT_A_VALUE (0x6a09e667)
#define SHA256_INITIAL_CONSTANT_B_VALUE (0xbb67ae85)
#define SHA256_INITIAL_CONSTANT_C_VALUE (0x3c6ef372)
#define SHA256_INITIAL_CONSTANT_D_VALUE (0xa54ff53a)
#define SHA256_INITIAL_CONSTANT_E_VALUE (0x510e527f)
#define SHA256_INITIAL_CONSTANT_F_VALUE (0x9b05688c)
#define SHA256_INITIAL_CONSTANT_G_VALUE (0x1f83d9ab)
#define SHA256_INITIAL_CONSTANT_H_VALUE (0x5be0cd19)

const uint64_t SHA256_round_constants[SHA256_ROUND_NUMBER] =
    {
...
uint8_t Fu8__sha256(hash_input_t *ptr_sstc_pssd_hash_input, hash_output_t *ptr_sstc_pssd_hash_output)
    ...
    */
    ...
    uint32_t u32_lcl_message_schedule[SHA256_ROUND_NUMBER];
    ...
    uint32_t u32_lcl_tmp_sha256_calcul_var_1;
    uint32_t u32_lcl_tmp_sha256_calcul_var_2;
    ...
    uint8_t  u8_lcl_message_block[SHA256_BLOCK_SIZE_IN_BYTE];
    ...
    */
    u32_lcl_A_block_data                         = SHA256_INITIAL_CONSTANT_A_VALUE;
    u32_lcl_B_block_data                         = SHA256_INITIAL_CONSTANT_B_VALUE;
    u32_lcl_C_block_data                         = SHA256_INITIAL_CONSTANT_C_VALUE;
    u32_lcl_D_block_data                         = SHA256_INITIAL_CONSTANT_D_VALUE;
    u32_lcl_E_block_data                         = SHA256_INITIAL_CONSTANT_E_VALUE;
    u32_lcl_F_block_data                         = SHA256_INITIAL_CONSTANT_F_VALUE;
    u32_lcl_G_block_data                         = SHA256_INITIAL_CONSTANT_G_VALUE;
    u32_lcl_H_block_data                         = SHA256_INITIAL_CONSTANT_H_VALUE;
    ...
    u32_lcl_tmp_sha256_calcul_var_1              = 0;
    u32_lcl_tmp_sha256_calcul_var_2              = 0;
    ...
    */ 
    u64_lcl_cnt = 0;
    while(u64_lcl_cnt < SHA256_ROUND_NUMBER)
        {
    ...
    */ 
    u64_lcl_cnt = 0;
    while(u64_lcl_cnt < SHA256_BLOCK_SIZE_IN_BYTE)
        {
    ...
    */ 
    u64_lcl_number_of_block_in_the_input_message = ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_ / SHA256_BLOCK_SIZE_IN_BYTE;

    /**
    * Check if the modulo of the length of the input message by the sha256 block size is not zero
    */
    if((ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_ % SHA256_BLOCK_SIZE_IN_BYTE) != 0)
        {
        /**
        * Treat the case when the modulo of the length of the input message by the sha256 block size is not zero
        */
    ...
    /**
    * Compute the sha256 hash using all the blocks message
    */ 
    u64_lcl_actual_block_number = 0;
    while((u64_lcl_actual_block_number < u64_lcl_number_of_block_in_the_input_message) || (u8_lcl_block_carry_padding_flag != FALSE) || (u8_lcl_padding_started_flag == FALSE))
        ...
        */
        if(u8_lcl_block_carry_padding_flag != FALSE)
            ...
            */
            (*((uint64_t *) (u8_lcl_message_block + SHA256_MESSAGE_LENGTH_POSITION_IN_BLOCK))) = u64_lcl_number_of_bit_in_message;
            ...
            */ 
            ...
            while(u64_lcl_cnt < SHA256_BLOCK_SIZE_IN_BYTE)
                ...
                */
                if(((u64_lcl_actual_block_number * SHA256_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt) >= ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_)
                    {
                    /**
                    ...
                    */
                    if(((u64_lcl_actual_block_number * SHA256_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt) == ptr_sstc_pssd_hash_input->u64_length_of_data_to_hash_)
                        ...
                        */
                        if(u64_lcl_cnt >= SHA256_MESSAGE_LENGTH_POSITION_IN_BLOCK)
                            {
                            /**
                        ...
                        */
                        if((u8_lcl_block_carry_padding_flag == FALSE) && (u64_lcl_cnt >= SHA256_MESSAGE_LENGTH_POSITION_IN_BLOCK))
                            {
                            /**
                    ...
                    */
                    ...
                    u8_lcl_message_block[u64_lcl_cnt] = ptr_sstc_pssd_hash_input->ptr_u8_data_to_hash_blob_[(u64_lcl_actual_block_number * SHA256_BLOCK_SIZE_IN_BYTE) + u64_lcl_cnt];
                    }
        ...
        */ 
        while(u64_lcl_cnt < SHA256_ROUND_NUMBER)
            {
            u32_lcl_tmp_sha256_calcul_var_1 = (MACRO_U32_RIGHT_ROTATE(u32_lcl_message_schedule[u64_lcl_cnt - 15], 7) ^ MACRO_U32_RIGHT_ROTATE(u32_lcl_message_schedule[u64_lcl_cnt - 15], 18)) ^ (u32_lcl_message_schedule[u64_lcl_cnt - 15] >> 3);

            u32_lcl_tmp_sha256_calcul_var_2 = (MACRO_U32_RIGHT_ROTATE(u32_lcl_message_schedule[u64_lcl_cnt - 2], 17) ^ MACRO_U32_RIGHT_ROTATE(u32_lcl_message_schedule[u64_lcl_cnt - 2], 19)) ^ (u32_lcl_message_schedule[u64_lcl_cnt - 2] >> 10);

            u32_lcl_message_schedule[u64_lcl_cnt] = u32_lcl_message_schedule[u64_lcl_cnt - 16] + u32_lcl_tmp_sha256_calcul_var_1 + u32_lcl_message_schedule[u64_lcl_cnt - 7] + u32_lcl_tmp_sha256_calcul_var_2;
        ...
        */ 
        ...
        while(u64_lcl_cnt < SHA256_ROUND_NUMBER)
            {
            u32_lcl_tmp_sha256_calcul_var_1 = u32_lcl_tmp_H_block_data + (MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_E_block_data, 6) ^ MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_E_block_data, 11) ^ MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_E_block_data, 25)) + ((u32_lcl_tmp_E_block_data & u32_lcl_tmp_F_block_data) ^ (~(u32_lcl_tmp_E_block_data) & u32_lcl_tmp_G_block_data)) + SHA256_round_constants[u64_lcl_cnt] + u32_lcl_message_schedule[u64_lcl_cnt];

            u32_lcl_tmp_sha256_calcul_var_2 = ((MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_A_block_data, 2)) ^ (MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_A_block_data, 13)) ^ (MACRO_U32_RIGHT_ROTATE(u32_lcl_tmp_A_block_data, 22))) + ((u32_lcl_tmp_A_block_data & u32_lcl_tmp_B_block_data) ^ (u32_lcl_tmp_A_block_data & u32_lcl_tmp_C_block_data) ^ (u32_lcl_tmp_B_block_data & u32_lcl_tmp_C_block_data));
            ...
            u32_lcl_tmp_E_block_data = (u32_lcl_tmp_D_block_data + u32_lcl_tmp_sha256_calcul_var_1);
            ...
            u32_lcl_tmp_A_block_data = (u32_lcl_tmp_sha256_calcul_var_1 + u32_lcl_tmp_sha256_calcul_var_2);
